    ...
    >
      {skills.map((skill, i) => {
        ...
        return (
          <motion.div
            key={i}
            className="absolute w-10 h-10 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center shadow-md"
            style={position}
            animate={{
              x: [0, 25, -20, 10, -10, 0],
              y: [0, -20, 15, -10, 10, 0],
...
export default SmallSkillBulbules;
